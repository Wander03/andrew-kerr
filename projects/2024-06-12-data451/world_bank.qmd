...
```{=html}
<iframe src="/files/world_bank/world_bank_report.pdf" width="100%" height="800px" style="border: none;">
  <p>Your browser does not support PDFs. <a href="/files/world_bank/world_bank_report.pdf">Download the PDF</a>.</p>
</iframe>
```
...
```{=html}
<iframe src="/files/world_bank/world_bank_poster.pdf" width="100%" height="800px" style="border: none;">
  <p>Your browser does not support PDFs. <a href="/files/world_bank/world_bank_poster.pdf">Download the PDF</a>.</p>
</iframe>
```
...
```{=html}
<iframe src="/files/world_bank/world_bank_slides.pdf" width="100%" height="800px" style="border: none;">
  <p>Your browser does not support PDFs. <a href="/files/world_bank/world_bank_slides.pdf">Download the PDF</a>.</p>
</iframe>
```
